...
\newcommand\profilingPlots[3]{%
    ...
    %
    \begin{frame}{%
            \ifthenelse{\equal{#1}{}}{}{\escape{#1}\ifthenelse{\equal{#2}{}}{}{,\space}}%
            \ifthenelse{\equal{#2}{}}{}{\escape{#2}\ifthenelse{\equal{#3}{}}{}{,\space}}%
            \ifthenelse{\equal{#3}{}}{}{\escape{#3}}%
        }%
