...
\newcommand\blockSizeProfilingPlot[1]{%
    \def\profilingPlots@width{\textwidth}%
    \def\profilingPlots@height{0.85\textheight}%
    %
    \makebox[\profilingPlots@width][c]{%
        \resizebox{!}{\profilingPlots@height}{%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{\thesisTitle*{}}
\author[\studentName*{}]{\studentName*{}\\{\tiny{Supervisor: \supervisorName*{}}}}
\date{\thesisDate*{}}
...
\label{algorithm}
\include{presentation/algorithm}
...
\section{Additional}
\label{additional}
\include{presentation/additional}
