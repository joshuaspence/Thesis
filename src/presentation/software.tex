...
\begin{frame}[label=profiling]{Algorithm Profiling}
    ...
    is attributed to the \escape{distance_squared} function --- a simple
    function which returns the square of the Euclidean distance between two
    given vectors.}
\end{frame}
...
\begin{frame}[label=functionExecutionTime]
    ...
    \escape{TopN_Outlier_Pruning_Block} function, sampled using 21 data sets
    with a size ranging from 441 2-dimensional vectors to 67557 43-dimensional
    vectors.
