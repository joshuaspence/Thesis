...
\begin{datasetDescription}{testCD}
    ...
    \datasetProperty{Data set information}{It contains one dense cluster of 500
        ...
        other clusters. $O_1$ is a local anomaly of dense cluster $C_1$.
    }
\end{datasetDescription}
...
\begin{datasetDescription}{segmentation}
    ...
    \datasetProperty{Attribute information}{
        \textbf{\texttt{region-centroid-col}:} The column of the center pixel of
            the region.\newline
        \textbf{\texttt{region-centroid-row}:} The row of the center pixel of
            the region.\newline
...
\begin{datasetDescription}{magicgamma}
    ...
    \datasetProperty{Attribute information}{
        ...
        \textbf{\texttt{fConc1}:} Ratio of highest pixel over
            \command{fSize}.\newline
        \textbf{\texttt{fAsym}:} Distance from highest pixel to center,
        ...
        \textbf{\texttt{fAlpha}:} Angle of major axis with vector to origin (in
            degrees).\newline
        \textbf{\texttt{fDist}:} Distance from origin to center of ellipse (in
            millimetres).\newline
