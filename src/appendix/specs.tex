...
using the \software{Hardware Lister} (\command{lshw}) tool.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% HOSTNAME: tuna
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Hostname: tuna}
The specifications for the \emph{tuna} are detailed in 
\autoref{specs:tuna:hardware}, \autoref{specs:tuna:software} and
\autoref{specs:tuna:os}.

\begin{specifications}{specs:tuna:hardware}{Hardware specifications for tuna}
...
\begin{specifications}{specs:tuna:software}{Software specifications for tuna}
...
\begin{specifications}{specs:tuna:os}{Operating System specifications for tuna}
...
The specifications for the \emph{ubuntu-vm} are detailed in 
\autoref{specs:ubuntu-vm:hardware}, \autoref{specs:ubuntu-vm:software}
and \autoref{specs:ubuntu-vm:os}.

\begin{specifications}{specs:ubuntu-vm:hardware}{Hardware specifications for ubuntu-vm}
    \specificationGroup{CPU}
        \specification{Product}{Intel\textregistered Core\texttrademark i7 CPU 950 @ 3.07GHz}
...
\begin{specifications}{specs:ubuntu-vm:software}{Software specifications for ubuntu-vm}
    \specification{gcc}{gcc (Ubuntu/Linaro 4.6.1-9ubuntu3) 4.6.1}
    \specification{ld}{GNU ld (GNU Binutils for Ubuntu) 2.22}
    \specification{MATLAB}{MATLAB 7.14.0.739 (R2012a)}
\end{specifications}

\begin{specifications}{specs:ubuntu-vm:os}{Operating System specifications for ubuntu-vm}
