...
\usepackage{../lib/gnuplot-lua-tikz/gnuplot-lua-tikz}
...
% command verbatiminput to input a whole file verbatim.
\usepackage{verbatim}
...
% My custom packages.
\usepackage{escape,citationneeded,pieplots,pgf-pie}
...
%===============================================================================
% Format the name of a command line command.
%-------------------------------------------------------------------------------
% \command{CMD}
%===============================================================================
...
%-------------------------------------------------------------------------------
% \begin{datasets}
% \dataset{DATASET}{SIZE}{DIMENSIONALITY}
% \end{datasets}
%===============================================================================
\makeatletter
\NewDocumentEnvironment{datasets}{m}{%
    \def\datasets@hline{}%
    ...
    \newcommand\dataSetBrief[3]{%
        \gdef\dataset@name{##1}%
        \gdef\dataset@size{##2}%
        \gdef\dataset@dimensionality{##3}%
        %
        \datasets@hline\dataset@name&\dataset@size&\dataset@dimensionality%
        \def\datasets@hline{\\}%
    }%
    %
...
% Glossary
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[acronym,toc,xindy]{glossaries} % note that hyperref must be loaded first
\makeglossaries
\input{acronym}

% Show abbreviated acronyms in the table of contents.
\usepackage{etoolbox}
\pretocmd{\listoffigures}{\glslocalunsetall[acronym]}{}{}
\apptocmd{\listoffigures}{\glslocalresetall[acronym]}{}{}
...
% Bibliography
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Allow URLs to break at numbers, uppercase characters and lowercase characters,
