...
\usepackage{mythesis}
\usepackage{biblatex}					% use biblatex instead of bibtex
\usepackage{gantt}						% for gantt charts
...
been performed without the prior research of \person{Chawla} and \person{Khoa}. 
Both were generous enough to lend their own support and expertise in order to 
gain an understanding of the implemented random projection algorithms.
...
\person{Chawla} from the \universityName{} has in recent years conducted and 
supervised new and exciting research oriented around random projections. In 
particular, \person{Khoa}, under the supervision of \person{Chawla} evaluated 
the use of traditional distance metrics, such as Euclidean distance and 
Mahalanobis distance, in the application of local anomaly detection. 
\person{Khoa} proposed the use of the \singleQuote{commute time} metric, derived
