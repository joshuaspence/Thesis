...
% well as you can print code snippets using a command similar to \verb. Many
% parameters control the output and if your preferred programming language
...
\newcommand\command[1]{\lstinline[language={none}]`#1`}
