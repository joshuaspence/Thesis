	...
	\begin{figure}
		\begin{center}
			...
			\begin{gantt}[
				...
				\ganttbar{Performance Benchmarking}{7}{4}
				\ganttbar{Design}{9}{12}
				\ganttbar{Implementation}{20}{12}
				\ganttbar{Review}{28}{8}
				
				\ganttmilestone{Topic Proposal Due}{6.68} % April 20
				\ganttmilestone{Progress Report Due}{12} % June 1
				\ganttmilestone{Draft Treatise Due}{29.56} % October 12
				\ganttmilestone{Final Treatise Due}{31.08} % October 24
				\ganttmilestone{Project Presentations}{33.2} % November 9
				%\ganttcon{4}{5}{4}{7}
			\end{gantt}
			}
		\end{center}
